  ...
  test("useLoginLocations should parse into Login Locations Array", () => {
    ...
    const queryResultsBundle = {
      ...
      entry: [
        {
          fullUrl:
            "http://localhost:8080/openmrs/ws/fhir2/R4/Location/083e75b0-5959-11e4-8ed6-0800200c9a66",
          resource: {
              ...
              tag: [
                {
                  ...
                  display:
                    "Signifies a Location where a radiology study can be ordered",
                },
                {
                  system: "http://fhir.openmrs.org/ext/location-tag",
                  code: "Transfer Location",
                  display:
                    "Patients may only be transfer to inpatient care in a location with this tag",
                },
              ],
            },
            text: {
        ...
        {
          fullUrl:
            "http://localhost:8080/openmrs/ws/fhir2/R4/Location/11857d81-5959-11e4-8ed6-0800200c9a66",
          resource: {
            resourceType: "Location",
              ...
              tag: [
                {
                  ...
                  display:
                    "A location that serves as an archives for storing medical records",
                },
                {
                  system: "http://fhir.openmrs.org/ext/location-tag",
                  code: "Check-In Location",
                  display:
                    "Signifies a Location where the check-in app and form should be available",
                },
              ],
            },
            text: {
        ...
        {
          fullUrl:
            "http://localhost:8080/openmrs/ws/fhir2/R4/Location/11857d80-5959-11e4-8ed6-0800200c9a66",
          resource: {
            resourceType: "Location",
            ...
            meta: {
              ...
              tag: [
                ...
                },
                {
                  ...
                  display:
                    "Signifies a Location where the registration app should be available",
                },
              ],
            },
            text: {
